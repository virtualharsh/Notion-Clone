...
const SidebarLayout = () => {
  ...
  return (
    <>
      ...
      <div
        className={`${
          sidebar ? "w-64 opacity-100" : "w-0 opacity-0 -translate-x-full"
      ...
      <div
        className={`fixed h-full bg-gray-900 transition-all duration-500 ease-in-out ${
          sidebar ? "left-64 w-[calc(100%-16rem)]" : "left-0 w-full"
        }`}
