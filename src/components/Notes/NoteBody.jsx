...
const NoteBody = () => {
    return (
        <div className='w-full h-full flex flex-col items-center pt-20 gap-y-10 bg-gray-900' style={{ zIndex: 1 }}> {/* Lower z-index */}
                ...
                {[...Array(5)].map((_, index) => (
                    ...
                    >
                        <div className='flex flex-col gap-y-3'>
                            ...
                            <p className='text-sm text-gray-300'>Complete project milestones and review tasks.</p>
                        </div>
